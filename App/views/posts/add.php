    ...
    <div class="h-auto w-auto">
        <div class="filter ">
            <div class="column my-2 rounded shadow">
                <input class="d-none" type="checkbox" name="filter" id="fillter1" value="fillter1" onclick="choose_filter()">
                <label for="fillter1"><img src="../public/img/fillter1.png" class="filter_img my-auto"></label>
            </div>
            <div class="column my-2 rounded shadow ">
                <input class="d-none" type="checkbox" name="filter" id="fillter2" value="fillter2" onclick="choose_filter()">
                <label for="fillter2"><img src="../public/img/fillter2.png" class="filter_img"></label>
            </div>
            <div class="column my-2 rounded shadow">
                <input class="d-none" type="checkbox" name="filter" id="fillter3" value="fillter3" onclick="choose_filter()">
                <label for="fillter3"><img src="../public/img/fillter3.png" class="filter_img"></label>
            </div>
            <div class="column my-2 rounded shadow">
                <input class="d-none" type="checkbox" name="filter" id="fillter4" value="fillter4" onclick="choose_filter()">
