...
?>
    ...
    <?php foreach($data['posts'] as $post) : ?>
        ...
        <div class="row px-3 mt-4 mb-4" >
            <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0 resp" >
                ...
                <div class="card-body h-100 comments1">
                    ...
                    <div class="cardbox-comments mt-2 mt-4 input-group">
                          <input type="text" name="comment_<?php echo $post->postId;?>" class="form-control w-50" placeholder="write a comment..." rows="1" style="resize:none; border:none"></textarea>
                            <i class = "fa fa-paper-plane pt-1"
                            data-c-user_id="<?php echo $_SESSION['user_id']; ?>" 
                            data-c-post_id="<?php echo $post->postId; ?>" 
                            onclick="comment(event)"
                            style="font-size:27px;background-color: white;color:blue; ">    
                            </i>
                    </div> 
                </div>
            </div>
            ...
            <div class="col-lg-10 col-xl-9 card card1 d-flex flex-row mx-auto px-4 m-3">
              <?php
                ...
                foreach ($data['likes'] as $like) {
                    if ($like->user_id == $_SESSION['user_id'] && $like->post_id == $post->postId) {
                        ...
                        <i class = "fa fa-heart"
                          ...
                          style="margin-right: 1rem!important;font-size:36px;color:rgb(223, 121, 172)">    
                        </i>
                        <?php
                    }
                }
                ...
                <?php }
                ?>
                  <strong><p id="li_nb_<?php echo $post->postId;?>" class="my-1 mx-1"><?php echo $post->like_nbr;?> </p></strong>
                  <strong><p class="my-1 ">Likes</p></strong>
                  <i class="fa fa-comments comments2 mx-4 " style="font-size:43px;color:rgb(223, 121, 172);margin-top: -.4rem!important;"></i>
            </div> 
        </div>
    <?php endforeach;  ?>
